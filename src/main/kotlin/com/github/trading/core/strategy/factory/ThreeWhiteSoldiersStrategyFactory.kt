...
class ThreeWhiteSoldiersStrategyFactory : LongStrategyFactory() {
    ...
    override fun initStrategy(parameters: StrategyParameters, series: BarSeries): TradeStrategy {
        ...
        val bullishEngulfingIndicator = ThreeWhiteSoldiersIndicator(series, barCount, DecimalNum.valueOf(factor, MathContext(4)))
    ...
    override fun strategyParameterNames() = ThreeWhiteSoldiersStrategyLongParameter.entries.map(ThreeWhiteSoldiersStrategyLongParameter::alias)
