...
data class StrategyAnalyzeRequestDto(
    ...
    @Schema(description = "Strategy parameters") val strategyParams: Map<String, Int>,
...
data class StrategyAdjustAndAnalyzeRequestDto(
    @Schema(description = "Strategy type") val strategyType: String,
    @Schema(description = "Strategy parameters") val strategyParams: Map<String, Int>,
    @Schema(description = "Mutable strategy parameters") val mutableStrategyParams: Map<String, Int>,
