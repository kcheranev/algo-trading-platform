...
import ru.kcheranev.trading.core.port.outcome.persistence.GetTradeSessionPersistenceOutcomeCommand
import ru.kcheranev.trading.core.port.outcome.persistence.SaveTradeSessionPersistenceOutcomeCommand
import ru.kcheranev.trading.core.port.outcome.persistence.TradeSessionPersistenceOutcomePort
...
class TradeSessionPersistenceOutcomeAdapter(
...
) : TradeSessionPersistenceOutcomePort {

    @Transactional(propagation = MANDATORY)
    override fun save(command: SaveTradeSessionPersistenceOutcomeCommand): TradeSessionId {
    ...
    override fun get(command: GetTradeSessionPersistenceOutcomeCommand): TradeSession {
