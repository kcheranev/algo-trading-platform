...
class BacktestingAnalyzeUiController(
    ...
    private val getStrategyParametersNamesUsesCase: GetStrategyParametersNamesUsesCase
) {
    ...
    fun strategyParameterNames(
        ...
        analyzeStrategyRequest.strategyParams.clear()
        getStrategyParametersNamesUsesCase.getStrategyParametersNames(
            GetStrategyParametersNamesCommand(analyzeStrategyRequest.strategyType!!)
        ).forEach { analyzeStrategyRequest.strategyParams.add(StrategyParamDto(it)) }
        return "backtesting/analyze"
    }
